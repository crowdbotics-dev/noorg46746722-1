"""
Django settings for noorg46746722_1 project.
...
ROOT_URLCONF = 'noorg46746722_1.urls'
...
WSGI_APPLICATION = 'noorg46746722_1.wsgi.application'
...
DEFAULT_FROM_EMAIL = env.str(
    "DEFAULT_FROM_EMAIL", "NoOrg46746722 Support <support@noorg46746722-1.botics.io>"
)
...
SPECTACULAR_SETTINGS = {
    ...
    "TITLE": "noorg46746722_1 API",
    "DESCRIPTION": "API documentation for noorg46746722_1 App",
    "VERSION": "v1",
}
...
if AS_BUCKET_NAME:
    ...
    DEFAULT_FILE_STORAGE = "noorg46746722_1.storage_backends.AzureMediaStorage"
    STATICFILES_STORAGE = "noorg46746722_1.storage_backends.AzureStaticStorage"
